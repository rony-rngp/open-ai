                        ...
                        <form action="{{ route('setting.website.store') }}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <input type="text" required name="site_title" id="site_title" class="form-control">
                                </div>

                                <div class="col-md-6 form-group mb-3">
                                    <label class="mb-2" for="site_url">Site Url (domainname only domain.com) <i class="text-danger">*</i></label>
                                    <input type="text" required name="site_url" id="site_url" class="form-control">
                                </div>

                                <div class="col-md-6 form-group mb-3">
                                    <label class="mb-2" for="wordpress_username">Wordpress Username <i class="text-danger">*</i></label>
                                    <input type="text" required name="wordpress_username" id="wordpress_username" class="form-control">
                                </div>

                                <div class="col-md-6 form-group mb-3">
                                    <label class="mb-2" for="wordpress_password">Wordpress Password <i class="text-danger">*</i></label>
                                    <input type="text" required name="wordpress_password" id="wordpress_password" class="form-control">
                                </div>
